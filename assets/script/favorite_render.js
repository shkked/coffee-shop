...
document.addEventListener('DOMContentLoaded', function () {
  if(localStorage.getItem('favorite')) {
      arrFav = JSON.parse(localStorage.getItem('favorite')) || [];
  } 
  arrFav?.forEach(item => {
    renderarrFav(item);
})
...
function emptyFav() {
  ...
  document.querySelector('.favorite-section').innerHTML = blockEmpty;
}
function renderarrFav({acidity, articleNumber, density, description, imgSrc, price, title}) {
