...
if(document.querySelector('#validationPhoneOrder')) {
          const elementorder = document.querySelector('#validationPhoneOrder');
                  const maskOptionsorder = {
                    mask: '+{7}(000)000-00-00'
                  };
                  IMask(elementorder, maskOptionsorder);
        }
