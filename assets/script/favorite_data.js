...
document.querySelectorAll('.card-body > a > .card-subtitle').forEach(elem => {
...
//   document.querySelector('.favorite-section').closest('.container-user').querySelector('.clear-btn').classList.add('d-none');
//   document.querySelector('.favorite-section').innerHTML = '<h2 class="text-center mt-5 h2-title nav-link-font">Cписок избранного пуст</h2>';
// }
// favoriteList?.forEach(item => {
//     renderFavoriteList(item);
// })
// function renderFavoriteList({acidity, articleNumber, density, description, imgSrc, price, title}) {
//   const favoriteContainer = document.querySelector('.favorite-section');
//   const favoriteItem = `<div class="col-12 mb-3 col-md-5 col-lg-4 item-block">
//   <div class="card">
...
//               <input type="range" class="form-range range-bg" id="toxic" value="${acidity}" disabled>
//             <label for="density" class="form-label amiko-font card-subtitle" style="color: #070707;">Плотность</label>
//               <input type="range" class="form-range" id="density" value="${density}" disabled>
//         </div>
...
//   </div>
// </div>`;
//   favoriteContainer.insertAdjacentHTML('afterbegin',favoriteItem);
// }