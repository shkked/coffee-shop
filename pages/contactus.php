    ...
    <main>
        <div class="container-user">
            <section class="d-flex align-center flex-column justify-center contact-us">
                <h1 class="text-start mt-5 nav-link-font h2-title">Наши контакты</h1>
                <p class="amiko-font text-black" style="font-size: 18px">Находимся по адресу <a target="_blank" style="font-size: 18px" href="https://yandex.ru/maps/213/moscow/house/pyatnitskaya_ulitsa_16s3/Z04YcAVnSkIEQFtvfXt1c3lgbQ==/?ll=37.628471%2C55.742493&utm_medium=mapframe&utm_source=maps&z=17.89" class="underlined text-black amiko-font">Пятницкая улица, 16с3</a> в двух минутах от метро 🚇 <span class="underlined">Новокузнецкая</span></p>
                <div class="map w-100">
