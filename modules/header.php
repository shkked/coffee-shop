<header class="p-3 border-bottom top-header" style="border-bottom: 1px solid black !important">
    <div class="container-user">
      <div class="d-flex row flex-lg-wrap align-items-center justify-content-center justify-content-lg-start">

        <ul class="nav col-md-8 col-lg-auto me-lg-auto mb-2 justify-content-lg-center mb-md-0">
        ...
        <?php if(isset($_COOKIE['role'])): ?>
          <div class="d-flex flex-row col-md-4 col-lg-auto align-items-center ">
          ...
          <?php else: ?>
            ...
            <div class="d-flex flex-row col-md-4 col-lg-auto align-items-center justify-content-md-end">
                <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" fill="dark" class="bi bi-person-fill me-3" viewBox="0 0 27 27">
                    <rect width="26.7721" height="26.076" rx="10" fill="dark"/>
                    <path d="M13.386 13.8174C15.3742 13.8174 16.9872 12.2464 16.9872 10.3099C16.9872 8.37351 15.3742 6.80244 13.386 6.80244C11.3979 6.80244 9.78489 8.37351 9.78489 10.3099C9.78489 12.2464 11.3979 13.8174 13.386 13.8174ZM16.587 14.5969C15.6787 14.5969 14.7879 14.8571 13.8852 14.9587C13.7213 14.9771 13.5548 14.9866 13.386 14.9866C13.2172 14.9866 13.0507 14.9771 12.8869 14.9586C11.9842 14.8569 11.0935 14.5969 10.185 14.5969C8.41696 14.5969 6.98401 15.9926 6.98401 17.7147V18.1044C6.98401 18.7499 7.52168 19.2736 8.18439 19.2736H18.5877C19.2504 19.2736 19.788 18.7499 19.788 18.1044V17.7147C19.788 15.9926 18.3551 14.5969 16.587 14.5969Z" 
                    fill="white"/>
...
<header class="p-3 main-header">
    <div class="container-user">
      <div class="d-flex flex-wrap row align-items-center justify-content-lg-center justify-content-lg-start">
        <a href="/" class="d-flex px-md-0 px-lg-2 col-md-2 align-items-center ms-lg-3 mb-2 mb-lg-0 me-md-2 me-lg-5 text-white text-decoration-none">
        ...
        <ul class="nav col-md-8 col-lg-auto me-lg-auto mb-2 justify-content-lg-center mb-md-0">
          ...
          <li><a href="/pages/contactus.php" class="pointer nav-link px-2 text-black nav-link-font">Контакты</a></li>
            ...
            <div class="d-flex col-md-1 col-lg-auto px-md-0 px-lg-2 flex-row align-items-center header-btns">
              <a data-bs-toggle="modal" data-bs-target="#contactus" type="button" class="d-flex d-md-none d-lg-flex align-items-center mb-0 btn me-2 sub-header-font" style="text-align: center; background-color: black; border-radius: 10px; color: white; min-height: 39px">
                Связь с нами
              </a>
              <a data-bs-toggle="modal" data-bs-target="#contactus" type="button" class="d-md-flex d-lg-none align-items-center justify-content-center mb-0 btn me-2" style="background-color: black; ">
              ...
              <a href="/pages/favorite.php" class="btn me-2 d-flex align-items-center justify-content-center" style="background-color: black">
