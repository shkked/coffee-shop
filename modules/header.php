    ...
    <div class="container-user">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li class="ms-5"><a href="/pages/howtomake.php" class="nav-link px-2 text-black sub-header-font">Как приготовить кофе?</a></li>
          <li class="ms-5"><a href="/pages/howtopick.php" class="nav-link px-2 text-black sub-header-font">Как выбрать кофе?</a></li>
        </ul>
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li><a href="/pages/contactus.php" class="pointer nav-link px-2 text-black nav-link-font">Контакты</a></li>
            ...
            <div class="d-flex flex-row align-items-center">
              ...
              <a class="btn btn" style="background-color: black" href="/pages/cart.php">
