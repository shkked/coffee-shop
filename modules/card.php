<div class="col-12 mb-3 col-md-5 col-lg-4">
                      <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-row align-items-center justify-content-between mt-3 pe-4">
                              <a href="#" class="amiko-font" style="text-align: center; color: black; font-size: 14px; font-style: normal; font-weight: 400;line-height: normal;">
                                в зернах 
